...
; wStatusFlags
	...
	const ENGINE_REGIONAL_DEX
	const ENGINE_LEARNED_FIELD_TECH
...
; wDailyFlags1
	const ENGINE_KURT_MAKING_BALLS 			; Reuse for post-game area
	const ENGINE_DAILY_BUG_CONTEST 			; Reuse for Safari Zone Daily Event
	const ENGINE_FISH_SWARM 				; Reuse for fishing swarm in East Kanto
	const ENGINE_DAISYS_GROOMING			; Re-implemented Daily Grooming (once/day)
	const ENGINE_PEWTER_SLOWPOKE_SITTING	; New event in Pewter (LGPE)
