...
; Gym Unlock Flags
	...
	const EVENT_GYMUNLOCK_BLUE
; Rods (Condense to one rod?)
	const EVENT_GOT_FISHING_ROD
; Hide/Show Events
	const EVENT_HIDE_STARTHOUSE_BLUE
	const EVENT_HIDE_STARTHOUSE_TRACE
	const EVENT_HIDE_STARTHOUSE_STARTER_PIKA
	const EVENT_HIDE_STARTHOUSE_STARTER_EEVEE
	const EVENT_HIDE_PALLETTOWN_OAK
	const EVENT_HIDE_OAKSLAB_OAK
	const EVENT_HIDE_OAKSLAB_TRACE
	const EVENT_HIDE_VIRIDIAN_CITY_OLD_MAN
	const EVENT_HIDE_ROUTE_22_TRACE
	const EVENT_HIDE_VIRIDIAN_FOREST_JESSIE
	const EVENT_HIDE_VIRIDIAN_FOREST_JAMES
	const EVENT_HIDE_PEWTERCITY_BLUE
	const EVENT_HIDE_PEWTERCITY_GYMGUY
	const EVENT_HIDE_PEWTERGYM_BROCK 	; Applies to everyone in Brock's gym at the start.
	const EVENT_HIDE_MUSEUM_FOSSIL_GUY	; He is out on Route 3 at the start.
; Story Events
	const EVENT_GOT_STARTER
	const EVENT_PLAYER_CHOSE_PIKACHU
	const EVENT_PLAYER_CHOSE_EEVEE
	const EVENT_BATTLED_OAKSLAB_RIVAL
	const EVENT_GOT_POKEDEX_FROM_OAK
	const EVENT_MET_JESSIE_JAMES
	const EVENT_CLEARED_MT_MOON
	const EVENT_GOT_SS_TICKET_FROM_BLUE
; Side Quests and Diversions
	const EVENT_ROUTE_22_SNORLAX ; Disappears after a certain point
	const EVENT_GOT_LURE_ROUTE_1
	const EVENT_VIRIDIAN_OLD_MAN_CATCH ; - UNUSED?
	const EVENT_WATCHED_POKEY
; To be replaced
	...
	const EVENT_LEARNED_TO_CATCH_POKEMON				; Used for Nuzlocke runs. Replace flag check with Oak cutscene (Or Overworld level > 0)
...
; Youngster
	const EVENT_BEAT_YOUNGSTER_DANNY ; (ROUTE 1)
...
; Kanto people
	...
	const EVENT_CINNABAR_LAB_MELTAN
...
; Chop Down trees
	const EVENT_ROUTE_2_CHOP_TREE_1
	const EVENT_ROUTE_2_CHOP_TREE_2
	const EVENT_ROUTE_2_CHOP_TREE_3
	const EVENT_ROUTE_2_CHOP_TREE_4
	const EVENT_ROUTE_2_CHOP_TREE_5
	const EVENT_ROUTE_8_CHOP_TREE_1
	const EVENT_ROUTE_8_CHOP_TREE_2
	const EVENT_ROUTE_9_CHOP_TREE
	const EVENT_ROUTE_10_CHOP_TREE_1
	const EVENT_ROUTE_10_CHOP_TREE_2
	const EVENT_ROUTE_10_CHOP_TREE_3
	const EVENT_ROUTE_10_CHOP_TREE_4
	const EVENT_ROUTE_12_CHOP_TREE_1
	const EVENT_ROUTE_12_CHOP_TREE_2
	const EVENT_ROUTE_13_CHOP_TREE
	const EVENT_ROUTE_14_CHOP_TREE_1
	const EVENT_ROUTE_14_CHOP_TREE_2
	const EVENT_ROUTE_14_CHOP_TREE_3
	const EVENT_ROUTE_16_CHOP_TREE
	const EVENT_ROUTE_16_WEST_CHOP_TREE_1
	const EVENT_ROUTE_16_WEST_CHOP_TREE_2
	const EVENT_ROUTE_25_CHOP_TREE
	const EVENT_ROUTE_29_CHOP_TREE_1
	const EVENT_ROUTE_29_CHOP_TREE_2
	const EVENT_ROUTE_30_CHOP_TREE
	const EVENT_ROUTE_31_CHOP_TREE_1
	const EVENT_ROUTE_31_CHOP_TREE_2
	const EVENT_ROUTE_32_CHOP_TREE
	const EVENT_ROUTE_35_CHOP_TREE
	const EVENT_ROUTE_42_CHOP_TREE
	const EVENT_ROUTE_43_CHOP_TREE
	const EVENT_CELADON_CITY_CHOP_TREE
	const EVENT_FUCHSIA_CITY_CHOP_TREE
	const EVENT_VERMILION_CITY_CHOP_TREE
	const EVENT_VIOLET_CITY_CHOP_TREE
	const EVENT_VIRIDIAN_CITY_CHOP_TREE_1
	const EVENT_VIRIDIAN_CITY_CHOP_TREE_2
	const EVENT_ILEX_FOREST_CHOP_TREE
	const EVENT_LAKE_OF_RAGE_CHOP_TREE_1
	const EVENT_LAKE_OF_RAGE_CHOP_TREE_2
	const EVENT_LAKE_OF_RAGE_CHOP_TREE_3
	const EVENT_LAKE_OF_RAGE_CHOP_TREE_4
	const EVENT_LAKE_OF_RAGE_CHOP_TREE_5
	const EVENT_SILVER_CAVE_OUTSIDE_CHOP_TREE_1
	const EVENT_SILVER_CAVE_OUTSIDE_CHOP_TREE_2
	const EVENT_MURKY_SWAMP_CHOP_TREE_1
	const EVENT_MURKY_SWAMP_CHOP_TREE_2
	const EVENT_NOISY_FOREST_CHOP_TREE_1
	const EVENT_NOISY_FOREST_CHOP_TREE_2
	const EVENT_ROUTE_49_CHOP_TREE_1
	const EVENT_ROUTE_49_CHOP_TREE_2
	const EVENT_MAGNET_TUNNEL_EAST_CHOP_TREE
	const EVENT_CHERRYGROVE_BAY_CHOP_TREE
