...
; Hide/Show Events
	...
	const EVENT_HIDE_OAKSLAB_TRACE ;EVENT_DECIDED_TO_HELP_LANCE
	const EVENT_HIDE_OAKSLAB_STARTER_PIKA ;EVENT_SPOKE_TO_LASS_CONNIE
	const EVENT_HIDE_OAKSLAB_STARTER_EEVEE ;EVENT_SPOKE_TO_GENTLEMAN_PRESTON
