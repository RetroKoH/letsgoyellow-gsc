...
; Main Story events
	...
	const EVENT_ENCOUNTERED_MEW ; Western Forest, next to Pallet Town
	...
	const EVENT_MET_JESSIE_JAMES_VIRIDIAN_FOREST
	const EVENT_BEAT_ROCKET_MT_MOON ; After beating Jessie/James
	const EVENT_BEAT_ROCKET_GAME_CORNER ; After beating Giovanni or Archer
	const EVENT_BEAT_ROCKET_LAVENDER_TOWER; After beating Jessie/James
	const EVENT_BEAT_ROCKET_SILPH_CO ; After beating Thu-fi-zer
	const EVENT_BEAT_ROCKET_SEAFOAM ; After beating Jessie/James (Optional)
	const EVENT_BEAT_ROCKET_CINNABAR_MANSION ; After beating Archer
	const EVENT_BEAT_ROCKET_VIRIDIAN_GYM ; After beating Jessie/James
	const EVENT_BEAT_ELITE_FOUR
	const EVENT_OAK_GAVE_YOU_MELTAN_BOX

; Side Quests/Events/Items
	const EVENT_GOT_POTION_ROUTE_1
	const EVENT_GOT_TOWN_MAP
	const EVENT_RECEIVED_OLD_AMBER
	const EVENT_CHOSE_DOME_FOSSIL
	const EVENT_CHOSE_HELIX_FOSSIL
	const EVENT_UNLOCKED_TECHNIQUES
...
; Hide/Show Events
	...
	const EVENT_MT_MOON_DOME_FOSSIL
	const EVENT_MT_MOON_HELIX_FOSSIL

; Trainers
	; Route 1 - None
	; Route 2 - None
	; Viridian Forest
	const EVENT_BEAT_LASS_BRITTANY
	const EVENT_BEAT_BUG_CATCHER_RICK
	const EVENT_BEAT_BUG_CATCHER_DOUG
	const EVENT_BEAT_BUG_CATCHER_ANTONY
	const EVENT_BEAT_BUG_CATCHER_CHARLY
	...
	; Route 7
	; Route 8
	const EVENT_BEAT_SUPER_NERD_AIDEN
	const EVENT_BEAT_GAMBLER_STAN
...
; Kanto Ball and Signpost (Hidden) Items
