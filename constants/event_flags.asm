...
; Kanto story events 	; KoH - Began new array of RBY event flags
	...
	const EVENT_BEAT_ROUTE_22_SNORLAX
...
; Kanto hidden items
	...
	const EVENT_VIRIDIAN_FOREST_HIDDEN_UNK
	const EVENT_VIRIDIAN_FOREST_HIDDEN_UNK2
	const EVENT_VIRIDIAN_FOREST_HIDDEN_UNK3
...
; Pewter Museum puzzles - KoH implementation of Alph puzzles in the Pewter Museum
	const EVENT_SOLVED_KABUTO_PUZZLE
	const EVENT_SOLVED_OMANYTE_PUZZLE
	const EVENT_SOLVED_AERODACTYL_PUZZLE

; Kanto Hide/Show Events - KoH Reimplementation of RBY Story Events
	...
	const EVENT_HIDE_ROUTE_22_BLUE
...
; Youngster
	const EVENT_BEAT_YOUNGSTER_RONNY		; Route 1
...
; Bug Catcher
	const EVENT_BEAT_BUG_CATCHER_DOUG		; Viridian Forest
	const EVENT_BEAT_BUG_CATCHER_RICK		; Viridian Forest
	const EVENT_BEAT_BUG_CATCHER_BRIAN		; Viridian Forest
	const EVENT_BEAT_BUG_CATCHER_ANTHONY	; Viridian Forest
	const EVENT_BEAT_BUG_CATCHER_SAMMY		; Viridian Forest
...
; Lass
	const EVENT_BEAT_LASS_JOANA				; Viridian Forest
	const EVENT_BEAT_LASS_BRITTANY			; Viridian Forest
...
; Kanto itemballs
	...
	const EVENT_VIRIDIAN_FOREST_POTION_1
	const EVENT_VIRIDIAN_FOREST_POTION_2
...
; NPC Flags
	const EVENT_NPCRED_ON_ROUTE_2
	const EVENT_NPCGREEN_ON_ROUTE_2
	const EVENT_NPCCHASE_ON_ROUTE_2
	const EVENT_NPCELAINE_ON_ROUTE_2
	const EVENT_CRYS_IN_ROUTE_2
