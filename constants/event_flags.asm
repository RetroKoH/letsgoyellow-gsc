...
; Hide/Show Events
	const EVENT_HIDE_STARTHOUSE_BLUE ;EVENT_GOT_EEVEE
	const EVENT_HIDE_STARTHOUSE_TRACE ;EVENT_DECIDED_TO_HELP_LANCE
	const EVENT_HIDE_STARTHOUSE_STARTER_PIKA ;EVENT_SPOKE_TO_LASS_CONNIE
	const EVENT_HIDE_STARTHOUSE_STARTER_EEVEE ;EVENT_SPOKE_TO_GENTLEMAN_PRESTON
	const EVENT_HIDE_PALLETTOWN_OAK ;EVENT_GOT_SECRETPOTION_FROM_PHARMACY
	const EVENT_HIDE_OAKSLAB_OAK ;EVENT_FOUGHT_SUDOWOODO
	const EVENT_HIDE_OAKSLAB_TRACE ;EVENT_HERDED_FARFETCHD
	const EVENT_HIDE_VIRIDIAN_CITY_OLD_MAN ;EVENT_INTRODUCED_TEALA
	const EVENT_HIDE_ROUTE_22_RIVAL ;EVENT_INTRODUCED_FELICITY
	const EVENT_HIDE_VIRIDIAN_FOREST_JESSIE
	const EVENT_HIDE_VIRIDIAN_FOREST_JAMES
; Story Events
	const EVENT_GOT_STARTER ;EVENT_GOT_A_POKEMON_FROM_ELM
	const EVENT_PLAYER_CHOSE_PIKACHU ;EVENT_GOT_CYNDAQUIL_FROM_ELM
	const EVENT_PLAYER_CHOSE_EEVEE ;EVENT_GOT_TOTODILE_FROM_ELM
	const EVENT_BATTLED_OAKSLAB_RIVAL ;EVENT_GOT_CHIKORITA_FROM_ELM
	const EVENT_GOT_POKEDEX_FROM_OAK
	const EVENT_MET_JESSIE_JAMES ;EVENT_GOT_SS_TICKET_FROM_ELM
	const EVENT_CLEARED_MT_MOON ;EVENT_DECO_MARILL_DOLL
	const EVENT_GOT_SS_TICKET_FROM_BLUE ;EVENT_JASMINE_RETURNED_TO_GYM
; Side Quests and Diversions
	const EVENT_GOT_LURE_ROUTE_1 ;EVENT_REFUSED_TO_HELP_LANCE_AT_LAKE_OF_RAGE
	const EVENT_VIRIDIAN_OLD_MAN_CATCH ;EVENT_MADE_WHITNEY_CRY - UNUSED
; To be replaced
