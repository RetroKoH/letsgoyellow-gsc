; mart types (see engine/items/mart.asm)
	...
	const MARTTYPE_BAZAAR		; DIALOGUE ONLY - "Come take a look at my wares" - Unused. Probably remove.
...
; Special Mart indexes (see data/items/marts.asm)
	...
	const MART_CELADON_2F_1		; Use as fixed general
	const MART_CELADON_2F_2		; Use for daily sales on select items (change daily)
