...
; TODO: remove unused effects
	...
	const EFFECT_SPIKES
	const EFFECT_FORESIGHT              ; UNUSED
	const EFFECT_PERISH_SONG            ; UNUSED
	const EFFECT_SANDSTORM
	const EFFECT_HAIL
	const EFFECT_ENDURE                 ; UNUSED < Coding used in certain items
	const EFFECT_ROLLOUT
	const EFFECT_SWAGGER
	const EFFECT_CONDITIONAL_BOOST
	const EFFECT_ATTRACT
	const EFFECT_RETURN
	const EFFECT_SACRED_FIRE          ; UNUSED
	...
	const EFFECT_FUTURE_SIGHT ; WILL BE MODIFIED FOR WISH
	const EFFECT_GUST
	const EFFECT_STOMP
