; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_LEAF_STORM ; Can also be used for OVERHEAT or DRACO METEOR
	const EFFECT_TAUNT
