...
;	const SPRITE_ANIM_INDEX_MEMORY_GAME
	...
	const SPRITE_ANIM_INDEX_CHOP_TREE
	const SPRITE_ANIM_INDEX_SKY_SOAR_LEAF
...
;	const SPRITE_ANIM_SEQ_MEMORY_GAME_CURSOR
	...
	const SPRITE_ANIM_SEQ_SKY_SOAR_FROM
	const SPRITE_ANIM_SEQ_SKY_SOAR_LEAF
	const SPRITE_ANIM_SEQ_SKY_SOAR_TO
