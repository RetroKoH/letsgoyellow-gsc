...
BattleTowerPokemon2:
	...
	db GROWTH, SLUDGE_BOMB, MEGA_DRAIN, WEATHER_BALL
	db BTDVS_HP_FIRE
	...
	db GASTLY
	db FOCUS_BAND
	db LICK, NIGHT_SHADE, HYPNOSIS, SHADOW_BALL
	db $de, $fd, $ee ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
...
BattleTowerMons3:
	...
	db PRIMEAPE
	db LUM_BERRY
	db LOW_KICK, KARATE_CHOP, FLAIL, FOCUS_ENERGY
	db $67, $76, $77 ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
	db $ff
...
BattleTowerMons5:
	...
	db JOLTEON
	db KINGS_ROCK
	db THUNDERBOLT, THUNDER_WAVE, SHADOW_BALL, WEATHER_BALL
	db $fe, $df, $ee ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
...
BattleTowerMons9:
	...
	db ESPEON
	db SITRUS_BERRY
	db PSYCHIC_M, SHADOW_BALL, SUNNY_DAY, SYNTHESIS
	db $fd, $df, $dd ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
