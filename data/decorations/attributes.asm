...
DecorationAttributes:
	...
	decoration DECO_POSTER,   EEVEE,             SET_UP_POSTER,      EVENT_DECO_POSTER_3,                $6f
	...
	decoration DECO_DOLL,     HOPPIP,            SET_UP_DOLL,        EVENT_DECO_CHIKORITA_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     LEDYBA,            SET_UP_DOLL,        EVENT_DECO_CYNDAQUIL_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     SKARMORY,          SET_UP_DOLL,        EVENT_DECO_TOTODILE_DOLL,           SPRITE_MON_DOLL_1
	...
	decoration DECO_DOLL,     DEWGONG,           SET_UP_DOLL,        EVENT_DECO_DEWGONG_DOLL,            SPRITE_MON_DOLL_1
	...
	decoration DECO_DOLL,     DRATINI,           SET_UP_DOLL,        EVENT_DECO_UNOWN_DOLL,              SPRITE_MON_DOLL_1
