...
Moves:: ; 41afb
	move TACKLE,       EFFECT_NORMAL_HIT,         55, NORMAL,    100, 15,   0, PHYSICAL ; POUND
	move KARATE_CHOP,  EFFECT_NORMAL_HIT,         50, FIGHTING,  100, 25,   0, PHYSICAL
	move TACKLE,       EFFECT_NORMAL_HIT,         15, NORMAL,     85, 10,   0, PHYSICAL ; MEGA_PUNCH
	...
	move CUT,          EFFECT_NORMAL_HIT,         50, NORMAL,     95, 30,   0, PHYSICAL ; VICE_GRIP
	move GUILLOTINE,   EFFECT_NORMAL_HIT,        200, NORMAL,     30,  5,   0, PHYSICAL ; OHKO
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         75, FLYING,     95, 15,  30, SPECIAL  ; RAZOR_WIND
	...
	move GUST,         EFFECT_GUST,               40, FLYING,    100, 35,   0, SPECIAL ; WHIRLWIND
	...
	move LOW_KICK,     EFFECT_NORMAL_HIT,          1, FIGHTING,  100, 20,  30, PHYSICAL ; MEGA_KICK
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,    100, 10, 100, SPECIAL  ; SAND_ATTACK
	...
	move FURY_STRIKES, EFFECT_FURY_STRIKES,       20, NORMAL,     85, 15,   0, PHYSICAL ; FURY ATTACK
	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         65, NORMAL,    100, 25,   0, PHYSICAL ; HORN_DRILL
	...
	move LEER,         EFFECT_DEFENSE_DOWN,        0, NORMAL,    100, 30,   0, STATUS ; TAIL_WHIP
	move POISON_STING, EFFECT_POISON_HIT,         15, POISON,    100, 35,  30, PHYSICAL
	move PIN_MISSILE,  EFFECT_DOUBLE_HIT,         25, BUG,        95, 20,   0, PHYSICAL ; TWINEEDLE
	...
	move SONIC_BOOM,   EFFECT_STATIC_DAMAGE,      20, NORMAL,     90, 20,   0, SPECIAL ; MIST
	...
	move CLOSE_COMBAT, EFFECT_CLOSE_COMBAT,      120, FIGHTING,  100,  5,   0, PHYSICAL ; SUBMISSION
	...
	move BULLDOZE,     EFFECT_EARTHQUAKE,        100, GROUND,    100, 10,   0, PHYSICAL ; FISSURE
	...
	move HONE_CLAWS,   EFFECT_HONE_CLAWS,          0, DARK,      100, 40,   0, STATUS ; MIMIC
	...
	move DEFENSE_CURL, EFFECT_DEFENSE_CURL,        0, NORMAL,    100, 40,   0, STATUS ; HARDEN
	...
	move DEFENSE_CURL, EFFECT_DEFENSE_CURL,        0, WATER,     100, 40,   0, STATUS ; WITHDRAW
	...
	move EXPLOSION,    EFFECT_EXPLOSION,         120, NORMAL,    100,  5,   0, PHYSICAL ; SELFDESTRUCT
	move LICK,         EFFECT_PARALYZE_HIT,       30, GHOST,     100, 30,  30, PHYSICAL
	move SMOKESCREEN,  EFFECT_POISON_HIT,         90, POISON,    100, 10,  30, SPECIAL ; SMOG
	...
	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL,    100, 15,  30, PHYSICAL ; SKULL_BASH
	...
	move SMOKESCREEN,  EFFECT_POISON_HIT,         90, POISON,    100, 10,  30, SPECIAL ; POISON_GAS
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          80, BUG,       100, 10,   0, PHYSICAL
	move SWEET_KISS,   EFFECT_SLEEP,               0, FAIRY,     100, 10,   0, STATUS ; LOVELY_KISS
	move BRAVE_BIRD,   EFFECT_RECOIL_HIT,        120, FLYING,    100, 15,   0, PHYSICAL ; SKY_ATTACK
	...
	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL,    100, 10,   0, STATUS ; ACID_ARMOR
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        100, WATER,      90, 10,   0, PHYSICAL
	move EXPLOSION,    EFFECT_EXPLOSION,         120, NORMAL,    100,  5,   0, PHYSICAL
...
;STRUGGLE
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,  100, 30,   0, PHYSICAL ; TRIPLE_KICK
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,      100, 25,  10, PHYSICAL
	move REVERSAL,     EFFECT_REVERSAL,            1, NORMAL,    100, 15,   0, PHYSICAL ; FLAIL
	...
	move CUT,          EFFECT_NORMAL_HIT,         50, BUG,        95, 30,   0, PHYSICAL ; FURY_CUTTER
	move HEAL_BELL,    EFFECT_HEAL_BELL,           0, NORMAL,    100,  5,   0, STATUS
	move RETURN,       EFFECT_RETURN,              1, NORMAL,    100, 20,   0, PHYSICAL
	move RETURN,       EFFECT_RECOIL_HIT,        105, UNKNOWN_T, 100, 20,   0, PHYSICAL ; FRUSTRATION
	...
	move HEALINGLIGHT, EFFECT_HEALING_LIGHT,       0, GRASS,     100,  5,   0, STATUS ; SYNTHESIS
	...
	move KNOCK_OFF,    EFFECT_PRIORITY_HIT,       65, NORMAL,    100, 20, 100, PHYSICAL ; FAKE_OUT
	...
	move METRONOME,    EFFECT_ENCORE,              0, DARK,      100, 10,   0, STATUS ; TAUNT
	move BATON_PASS,   EFFECT_BATON_PASS,          0, NORMAL,    100, 40,   0, STATUS ; HELPING_HAND
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      120, PSYCHIC,   100, 10,   0, SPECIAL ; WISH
	move STRENGTH,     EFFECT_NORMAL_HIT,         80, FIGHTING,  100, 15,   0, PHYSICAL ; SUPERPOWER
	move CURSE,        EFFECT_CURSE,               0, GHOST,     100, 10,   0, STATUS ; RECYCLE
	move BRICK_BREAK,  EFFECT_BRICK_BREAK,        75, FIGHTING,  100, 15,   0, PHYSICAL ; WAS ROCK_SMASH
	move SWAGGER,      EFFECT_PERISH_SONG,         0, NORMAL,    100,  5,   0, STATUS ; YAWN
	move KNOCK_OFF,    EFFECT_KNOCK_OFF,          65, DARK,      100, 20, 100, PHYSICAL
	move HYPER_VOICE,  EFFECT_NORMAL_HIT,         90, NORMAL,    100, 10,   0, SPECIAL
	move BITE,         EFFECT_POISON_HIT,         80, POISON,    100, 20,  50, PHYSICAL ; POISON_FANG
	move GIGA_IMPACT,  EFFECT_ATTACK_UP_HIT,     120, STEEL,     100,  5,   0, PHYSICAL ; METEOR_MASH
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,       60, NORMAL,    100, 15,   0, SPECIAL ; REPLACE WITH WEATHER BALL
	move CONFUSE_RAY,  EFFECT_CONFUSE_HIT,        60, BUG,       100, 10,   0, SPECIAL ; SIGNAL BEAM
	...
	move SPARK,        EFFECT_PARALYZE_HIT,      120, ELECTRIC,   50,  5, 100, PHYSICAL ; VOLT TACKLE
	move CALM_MIND,    EFFECT_CALM_MIND,           0, PSYCHIC,   100, 20,   0, STATUS
	move CUT,          EFFECT_NORMAL_HIT,         50, GRASS,      95, 30,   0, PHYSICAL ; LEAF_BLADE
	...
	move FEINT_ATTACK, EFFECT_ALWAYS_HIT,         60, DARK,      100, 20,   0, PHYSICAL ; FEINT
	...
	move FALSE_SWIPE,  EFFECT_NORMAL_HIT,         40, PSYCHIC,   100, 40,   0, PHYSICAL ; PSYCHO_CUT
	...
	move PETAL_DANCE,  EFFECT_NORMAL_HIT,         90, GRASS,     100, 10,   0, SPECIAL ; LEAF_STORM
	move POWER_WHIP,   EFFECT_NORMAL_HIT,        120, GRASS,      85, 10,   0, PHYSICAL
	move POWER_GEM,    EFFECT_HYPER_BEAM,        150, ROCK,      100, 20,   0, PHYSICAL ; ROCK_WRECKER
	move X_SCISSOR,    EFFECT_NORMAL_HIT,         80, POISON,    100, 15,   0, PHYSICAL ; CROSS_POISON
	...
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,    100, 20,   0, STATUS ; STEALTH_ROCK
	move SEED_BOMB,    EFFECT_LOW_KICK,            1, GRASS,     100, 15,   0, SPECIAL ; GRASS KNOT
	move BUG_BITE,     EFFECT_BUG_BITE,           60, BUG,       100, 20,   0, PHYSICAL
	move AQUA_JET,     EFFECT_PRIORITY_HIT,       40, WATER,     100, 20,   0, PHYSICAL
	move DRAGON_DANCE, EFFECT_DRAGON_DANCE,        0, BUG,       100, 20,   0, STATUS ; QUIVER_DANCE
	move BODY_SLAM,    EFFECT_BODY_SLAM,          85, STEEL,     100, 15,  30, PHYSICAL ; HEAVY SLAM
	move DRAGON_DANCE, EFFECT_DRAGON_DANCE,        0, POISON,    100, 20,   0, STATUS ; COIL
	move PLAY_ROUGH,   EFFECT_NORMAL_HIT,         90, DARK,       90, 10,  10, PHYSICAL ; FOUL_PLAY
	move SMOKESCREEN,  EFFECT_HAZE,				   0, POISON,    100, 10,   0, STATUS ; CLEAR_SMOG
	move SCALD,        EFFECT_BURN_HIT,           80, WATER,     100, 15,  30, SPECIAL
	move SCARY_FACE,   EFFECT_SPEED_DOWN_2,        0, NORMAL,    100, 10,   0, STATUS ; SHELL_SMASH
	move HEX,          EFFECT_CONDITIONAL_BOOST,  65, GHOST,     100, 10,   0, SPECIAL
	move DRAGON_CLAW,  EFFECT_NORMAL_HIT,         80, DRAGON,    100, 15,   0, PHYSICAL ; DRAGON_TAIL
	move WILD_CHARGE,  EFFECT_RECOIL_HIT,         90, ELECTRIC,  100, 15,   0, PHYSICAL
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         60, GROUND,    100, 30,   0, PHYSICAL ; DRILL_RUN
	move HURRICANE,    EFFECT_CONFUSE_HIT,       110, FLYING,     70, 10,  30, SPECIAL
	move VENOSHOCK,    EFFECT_NORMAL_HIT,         65, BUG,       100, 10,   0, SPECIAL ; FELL_STINGER
	...
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FAIRY,      95,  5,   0, SPECIAL ; FAIRY_WIND
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,    95, FAIRY,     100, 15,  30, SPECIAL
	move DAZZLINGLEAM, EFFECT_ACCURACY_DOWN_HIT,  60, FAIRY,     100, 10,   0, SPECIAL
	move CRABHAMMER,   EFFECT_RECOIL_HIT,         90, DRAGON,    100, 15,   0, PHYSICAL ; DRAGON_HAMMER
	move BONEMERANG,   EFFECT_FLINCH_HIT,         50, GHOST,      90, 10,   0, PHYSICAL ; SHADOW_BONE
	move ASTONISH,     EFFECT_FLINCH_HIT,         30, WATER,     100, 15,  30, PHYSICAL ; LIQUIDATION
	move EXTREMESPEED, EFFECT_DOUBLE_HIT,         80, STEEL,     100,  5,   0, PHYSICAL ; DOUBLEIRONBASH
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, FAIRY,      85, 10,  50, SPECIAL ; STRANGE_STEAM
