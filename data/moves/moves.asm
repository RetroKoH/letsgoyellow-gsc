...
Moves:: ; 41afb
	...
	move TWINEEDLE,    EFFECT_DOUBLE_HIT,         35, BUG,       100, 20,   0, PHYSICAL
	...
	move SMOG,         EFFECT_POISON_HIT,         40, POISON,    100, 20,   0, SPECIAL
...
; STRUGGLE
	...
	move FAKE_OUT,     EFFECT_FAKE_OUT,           40, NORMAL,    100, 10,   0, PHYSICAL ; Should only work if turns taken is 0
