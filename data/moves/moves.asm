...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move RAZOR_WIND,   EFFECT_SOLAR_BEAM,        130, NORMAL,    100, 10,   0, SPECIAL ; Sp Def up; Remove EFFECT_HONE_CLAWS
	...
	move SKULL_BASH,   EFFECT_SOLAR_BEAM,        130, NORMAL,    100, 10,   0, PHYSICAL ; Add DEF UP effect; Remove EFFECT_STATIC_DAMAGE
	...
	move TRIPLE_KICK,  EFFECT_DOUBLE_HIT,         20, FIGHTING,   90, 10,   0, PHYSICAL ; Add EFFECT_TRIPLE_KICK
	...
	move BULLET_SEED,  EFFECT_NORMAL_HIT,         80, GRASS,     100, 15,   0, PHYSICAL ; Change to Triple Kick Effect
	...
	move FREEZE_DRY,   EFFECT_FREEZE_HIT,         75, ICE,       100, 20, 100, SPECIAL ; Add effect to be super effective on water
	...
	move DUOIRONBASH,  EFFECT_DOUBLE_HIT,         60, STEEL,     100,  5,   0, PHYSICAL ; Need to add 30% Flinch
