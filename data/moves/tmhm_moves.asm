TMHMMoves:
	...
	db SIGNAL_BEAM  ; TM20 (Celadon Dept. Store)
	...
	db FOUL_PLAY    ; TM46 (Team Rocket Base)
	db HEAVY_SLAM   ; TM47 (Route 28)
	...
	db FAKE_OUT     ; TM54 (Ilex Forest Gate)
	...
	db MEGA_KICK    ; HM04 (Cianwood City)
