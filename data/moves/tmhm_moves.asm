...
; entries correspond to *_TMNUM constants (see constants/item_constants.asm)
	...
	db WEATHER_BALL ; TM10 (Lake of Rage)
	db SUNNY_DAY    ; TM11 (Celadon Dept. Store)
	db SKY_ATTACK   ; TM12 (Route 35)
	...
	db GRASS_KNOT   ; TM19 (Erika)
	db AURORA_VEIL  ; TM20 (Celadon Dept. Store)
	...
	db FELL_STINGER ; TM65 (Lake of Rage)
	db POISON_JAB   ; TM66 (Janine)
	db AVALANCHE    ; TM67 (Pryce)
	db HEAVY_SLAM   ; TM68 (Celadon Game Corner)
	db U_TURN       ; TM69 (Bugsy)
	db DAZZLINGLEAM ; TM70 (Sprout Tower)
	...
	db SUPERPOWER   ; HM04 (Cianwood City)
	...
	db BULLET_SEED   ; MT21 (Yellow Forest)
	db SEISMIC_TOSS ; MT22 (Pewter City)
	db FOUL_PLAY    ; MT23 (Route 27)
	db STRIKE       ; MT24 (Route 31)***
	db SUCKER_PUNCH ; MT25 (Scary Cave)
	db DRILL_RUN    ; MT26 (Celadon City)
	db THUNDERPUNCH ; MT27 (Goldenrod City)
	db FEINT        ; MT28 (Battle Tower)
	db TRICK_ROOM   ; MT29 (TODO)
	db VOLT_TACKLE  ; MT30 (Power Plant)
