...
SongInfo:
	...
	song_info "Opening", ORIGIN_Y, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Title Screen", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Main Menu", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Pallet Town", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_NONE
	song_info "Mom", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Oak Appears", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Oak's Lab", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Kanto Routes 1", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Kanto Routes 2", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Nugget Bridge", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Kanto Routes 3", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Viridian City", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Cerulean City", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Lavender Town", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_NONE
	song_info "Lavender Town       (Eerie)", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vermilion City", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Celadon City", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Cinnabar Island", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "#mon League", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Secret Garden       (National Park)", ORIGIN_GS, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Mt. Moon", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Mt. Moon Square", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Rock Tunnel         (Union Cave)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Power Plant", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "#mon Tower", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Seafoam Islands     (Ice Path)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Cerulean Cave", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "GO Rocket Hideout   (Silph Co)", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Celadon Game Corner", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "#mon Center", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "# Mart", ORIGIN_HGSS, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "Gym", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Vs. Wild #mon", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vs. Wild #mon    (Night Version)", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_TRITEHEXAGON
	song_info "Vs. Wild #mon    (Safari Zone)", ORIGIN_GO, COMPOSER_JUNICHI_MASUDA, COMPOSER_SHOCKSLAYER
	song_info "Vs. Legendary", ORIGIN_XY, COMPOSER_JUNICHI_MASUDA, COMPOSER_GACT_PIGU
	song_info "Vs. Mewtwo", ORIGIN_STADIUM, COMPOSER_JUNICHI_MASUDA, COMPOSER_SHOCKSLAYER
	song_info "Vs. Trainer", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vs. Gym Leader", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vs. Johto Leader", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vs. GO Rocket", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vs. Elite Four", ORIGIN_SM, COMPOSER_JUNICHI_MASUDA, COMPOSER_MMMMMM
	song_info "Vs. Champion", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vs. Red", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Caught #mon!", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Victory! Wild", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Victory! Trainer", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Victory! Gym Leader", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Evolution", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Rival Appears", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Spotted! Trainer", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Spotted! Lass", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Spotted! GO Rocket", ORIGIN_GS, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Rival Departs", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Credits", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Post-Credits", ORIGIN_GS, COMPOSER_GO_ICHINOSE, COMPOSER_NONE

; Tracks that will remain unused, or altogether repurposed
	song_info "Goldenrod City      (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Route 30            (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Final #mon", ORIGIN_BW, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_MMMMMM
	song_info "Ecruteak City       (UNUSED)", ORIGIN_GS, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Dance Theater       (UNUSED)", ORIGIN_GS, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Burned Tower        (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Lyra Appears        (UNUSED)", ORIGIN_HGSS, COMPOSER_SHOTA_KAGEYAMA, COMPOSER_MMMMMM
	song_info "Route 37            (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Olivine Lighthouse  (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Cianwood City       (UNUSED)", ORIGIN_HGSS, COMPOSER_GO_ICHINOSE, COMPOSER_MMMMMM
	song_info "Route 47            (UNUSED)", ORIGIN_HGSS, COMPOSER_HITOMI_SATO, COMPOSER_MMMMMM
	song_info "Route 42            (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Stark Mountain      (UNUSED)", ORIGIN_DPPT, COMPOSER_GO_ICHINOSE, COMPOSER_FROGGESTSPIRIT
	song_info "Rocket Radio        (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Route 11/36???      (UNUSED)", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Duplicate Track     (UNUSED)", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Lyra Departs        (UNUSED)", ORIGIN_HGSS, COMPOSER_SHOTA_KAGEYAMA, COMPOSER_MMMMMM
	...
	song_info "New Bark Town", ORIGIN_GS, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Elm's Lab", ORIGIN_RB, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
