	...
	tms HEADBUTT, HELPING_HAND, REST, PROTECT, SUBSTITUTE, REFLECT, DIG, WILL_O_WISP, FACADE, IRON_TAIL, DRAGON_PULSE, FLAMETHROWER, OUTRAGE, PLAY_ROUGH, SOLAR_BEAM, FIRE_BLAST, HYPER_BEAM, SUPERPOWER, SUNNY_DAY, BULLDOZE
