...
endc
	...
	; tmhm
	tmhm CURSE, TOXIC, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, GIGA_DRAIN, SOLAR_BEAM, RETURN, ROOST, DOUBLE_TEAM, SLUDGE_BOMB, SWIFT, AERIAL_ACE, SUBSTITUTE, FACADE, REST, THIEF, ROCK_SMASH, LEECH_LIFE, FALSE_SWIPE, X_SCISSOR, ENDURE, POISON_JAB, GIGA_IMPACT, U_TURN, FLASH, SWORDS_DANCE, CUT, DOUBLE_EDGE, KNOCK_OFF, SLEEP_TALK, SWAGGER
	; end
