	...
	tms HEADBUTT, HELPING_HAND, TELEPORT, REST, LIGHT_SCREEN, PROTECT, SUBSTITUTE, REFLECT, FACADE, BRICK_BREAK, DRAGON_TAIL, IRON_TAIL, CALM_MIND, DRAGON_PULSE, FLAMETHROWER, OUTRAGE, PSYCHIC, EARTHQUAKE, EXPLOSION, SOLAR_BEAM, HYPER_BEAM, SUPERPOWER, SLUDGE_BOMB, MEGA_DRAIN, DREAM_EATER, SUNNY_DAY, TRICK_ROOM, BULLET_SEED, ENERGY_BALL, BULLDOZE
