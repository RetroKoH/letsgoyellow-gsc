	...
	tms HEADBUTT, TAUNT, HELPING_HAND, TELEPORT, REST, LIGHT_SCREEN, PROTECT, SUBSTITUTE, REFLECT, FACADE, BRICK_BREAK, SEISMIC_TOSS, THUNDER_WAVE, FOUL_PLAY, DAZZLINGLEAM, CALM_MIND, ICE_PUNCH, THUNDERBOLT, THUNDER, PSYCHIC, SHADOW_BALL, SOLAR_BEAM, HYPER_BEAM, BLIZZARD, ICE_BEAM, DREAM_EATER, RAIN_DANCE, HAIL, TRICK_ROOM, DRAIN_PUNCH, ENERGY_BALL
