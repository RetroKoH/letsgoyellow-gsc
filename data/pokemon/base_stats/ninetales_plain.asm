	...
	tms HEADBUTT, HELPING_HAND, REST, PROTECT, SUBSTITUTE, REFLECT, DIG, WILL_O_WISP, FACADE, IRON_TAIL, DARK_PULSE, FOUL_PLAY, CALM_MIND, FLAMETHROWER, SHADOW_BALL, SOLAR_BEAM, FIRE_BLAST, HYPER_BEAM, DREAM_EATER, SUNNY_DAY, ENERGY_BALL
