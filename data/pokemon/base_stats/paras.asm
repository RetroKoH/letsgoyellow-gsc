	...
	tms HEADBUTT, HELPING_HAND, REST, LIGHT_SCREEN, PROTECT, SUBSTITUTE, REFLECT, DIG, FACADE, BRICK_BREAK, X_SCISSOR, SOLAR_BEAM, SLUDGE_BOMB, MEGA_DRAIN, FALSE_SWIPE, BULLET_SEED, ENERGY_BALL
