	...
	tms HEADBUTT, HELPING_HAND, REST, PROTECT, SUBSTITUTE, DIG, FACADE, IRON_TAIL, ROCK_SLIDE, BULK_UP, OUTRAGE, EARTHQUAKE, SURF, HYPER_BEAM, WORK_UP, DRILL_RUN, SANDSTORM, BULLDOZE, SMART_STRIKE
