	...
	; tmhm
	tmhm CURSE, TOXIC, HAIL, HIDDEN_POWER, ICE_BEAM, BLIZZARD, PROTECT, RAIN_DANCE, GIGA_DRAIN, SAFEGUARD, RETURN, DOUBLE_TEAM, SLUDGE_BOMB, SUBSTITUTE, FACADE, REST, THIEF, DAZZLINGLEAM, LEECH_LIFE, SCALD, ENDURE, WATER_PULSE, POISON_JAB, SWORDS_DANCE, CUT, SURF, WHIRLPOOL, WATERFALL, DOUBLE_EDGE, ICY_WIND, KNOCK_OFF, SLEEP_TALK, SWAGGER
	; end
