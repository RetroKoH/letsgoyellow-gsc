...
; ================
	...
	db 71, BUTTERFREE, KINGS_ROCK, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db 19, CLEFAIRY, NO_ITEM, 48, ABILITY_1 | NAT_NEUTRAL, FEMALE
		db METRONOME, DISARM_VOICE, MEGA_PUNCH, ATTRACT
...
; ================
	...
	db 71, KADABRA, TWISTEDSPOON, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db 30, PRIMEAPE, NO_ITEM, 80
		db LOW_SWEEP, SEISMIC_TOSS, SCREECH, DYNAMICPUNCH
if DEF(FAITHFUL)
	db 29, MACHOKE, NO_ITEM, 80
		db LOW_SWEEP, BULLET_PUNCH, BULK_UP, DYNAMICPUNCH
else
...
; ================
	...
	db 72, MAGNEZONE, MIRACLE_SEED, DVS_HP_GRASS
		db THUNDERBOLT, SWIFT, FLASH_CANNON, EXPLOSION
...
; ================
	...
	db 42, MAMOSWINE, SITRUS_BERRY, 112
		db DRILL_RUN, ANCIENTPOWER, AVALANCHE, FURY_STRIKES
	db -1 ; end
...
; ================
	...
	db 71, GLACEON, NEVERMELTICE, DVS_HP_GROUND
		db ICE_BEAM, SWIFT, BARRIER, BATON_PASS
...
; ================
	...
	db 74, EXEGGUTOR, LUM_BERRY, ABIL_EXEGGUTOR_HARVEST | NAT_NEUTRAL, FEMALE
		db REST, SLEEP_POWDER, MEGA_DRAIN, DRAGON_PULSE
...
; ================
	...
	db 50, ARIADOS, SITRUS_BERRY, 160
		db DOUBLE_TEAM, GLARE, BATON_PASS, MEGA_DRAIN
...
if DEF(FAITHFUL)
		db SUNNY_DAY, HEALINGLIGHT, MEGA_DRAIN, EARTH_POWER
else
		db SUNNY_DAY, HEALINGLIGHT, MEGA_DRAIN, FLAMETHROWER
endc
...
if DEF(FAITHFUL)
	...
	db 61, POLITOED, NO_ITEM, 192
		db MEGA_DRAIN, SCALD, ICE_BEAM, FOCUS_BLAST
endc
...
if DEF(FAITHFUL)
		...
		db SUNNY_DAY, LEECH_SEED, MEGA_DRAIN, FIRE_BLAST
endc
	...
	db 73, VICTREEBEL, POISON_BARB, FAKE_PERFECT_DVS
		db SWORDS_DANCE, MEGA_DRAIN, SLUDGE_BOMB, SEED_BOMB
...
; ================
	...
	db 72, ARIADOS, QUICK_CLAW
		db SCARY_FACE, POISON_JAB, MEAN_LOOK, MEGA_DRAIN
...
endc
	...
	db 74, EXEGGUTOR, MIRACLE_SEED
		db PSYCHIC_M, LEECH_SEED, SEED_BOMB, MEGA_DRAIN
...
; ================
	...
	db 98, MOLTRES, CHARCOAL, DVS_HP_GRASS, ABIL_MOLTRES_FLAME_BODY | NAT_SATK_UP_ATK_DOWN, FEMALE
		db FIRE_BLAST, AIR_SLASH, SWIFT, EXTRASENSORY
...
; ================
	...
	db 43, KADABRA, NO_ITEM, 132, "@"
	db 45, ARCANINE, NO_ITEM, 132, "@"
	db 45, WIGGLYTUFF, NO_ITEM, 132, "@"
...
; ================
	...
	db 70, WIGGLYTUFF, NO_ITEM, "@"
	db 71, AMPHAROS, NO_ITEM, "@"
	db 68, KADABRA, NO_ITEM, "@"
...
if DEF(FAITHFUL)
		...
		db LEECH_SEED, MEGA_DRAIN, SUNNY_DAY, FLAMETHROWER
endc
	db 34, SUNFLORA
if DEF(FAITHFUL)
		db MEGA_DRAIN, SOLAR_BEAM, SUNNY_DAY, EARTH_POWER
else
		db MEGA_DRAIN, SOLAR_BEAM, SUNNY_DAY, FLAMETHROWER
endc
	db 38, VENUSAUR
...
; ================
	...
	db 30, MAGIKARP, ABILITY_1 | NAT_NEUTRAL, MALE | MAGIKARP_CALICO2_FORM
		db SPLASH, TACKLE, REVERSAL, DRAGONBREATH
...
; ================
	...
	; party
	db 34, GRAVELER
		db DRILL_RUN, MUD_SLAP, SANDSTORM, ROCK_SLIDE
	db 36, GOLEM
...
; ================
	...
	db 36, DUGTRIO
		db DRILL_RUN, DIG, MUD_SLAP, SLASH
	db 39, STEELIX
...
; ================
	...
	; party
	db 60, JIGGLYPUFF, EVIOLITE, ABIL_JIGGLYPUFF_CUTE_CHARM | NAT_NEUTRAL, FEMALE
	db 63, WIGGLYTUFF, LEFTOVERS, ABIL_WIGGLYTUFF_CUTE_CHARM | NAT_NEUTRAL, FEMALE
	db 60, JIGGLYPUFF, BLACK_BELT, ABIL_JIGGLYPUFF_CUTE_CHARM | NAT_NEUTRAL, FEMALE
	db -1 ; end
...
; ================
	...
	; party
	db 25, MACHOP
		db LEER, FOCUS_ENERGY, LOW_SWEEP, SEISMIC_TOSS
	db 25, MACHOKE
...
; ================
	...
	db 24, HAUNTER, ABILITY_1 | NAT_NEUTRAL, MALE
