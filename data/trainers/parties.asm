...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	db 73, PIDGEOT, TWISTEDSPOON
		db AIR_SLASH, PSYCHIC_M, HYPNOSIS, DREAM_EATER
	db 70, DUGTRIO, SCOPE_LENS
...
; ================
	...
	db 14, VENONAT, NO_ITEM, 32, ABILITY_1 | QUIRKY, FEMALE
...
; ================
	...
	db 70, VENOMOTH, QUICK_CLAW, ABILITY_1 | QUIRKY, FEMALE
if DEF(FAITHFUL)
...
; ================
	...
	db 20, CLEFAIRY, NO_ITEM, 48, ABILITY_1 | QUIRKY, FEMALE
...
; ================
	...
	db 70, KANGASKHAN, BLACK_BELT, ABILITY_1 | QUIRKY, FEMALE
		db SWORDS_DANCE, CROSS_CHOP, CRUNCH, PLAY_ROUGH
	db 71, GROWLITHE, TWISTEDSPOON, ABILITY_1 | QUIRKY, FEMALE
...
if DEF(FAITHFUL)
	...
	db 24, PIDGEOT, NO_ITEM, 64, ABILITY_1 | QUIRKY, MALE
		db HYPNOSIS, FORESIGHT, CONFUSION, HEX
endc
	db 25, GASTLY, NO_ITEM, 64, ABILITY_1 | QUIRKY, MALE
...
; ================
	...
	db 73, HAUNTER, PINK_BOW, ABILITY_1 | QUIRKY, MALE
...
if DEF(FAITHFUL)
	...
	db 74, PIDGEOT, SHARP_BEAK, ABILITY_1 | QUIRKY, MALE
...
; ================
	...
	; party
	db 74, FEAROW, LEFTOVERS, $EE, $EE, $EE
	...
	db 73, GRAVELER, SOFT_SAND, $EE, $EE, $EE
...
; ================
	...
	db 72, MAROWAK, KINGS_ROCK, FAKE_PERFECT_DVS
	...
	db 75, LAPRAS, HARD_STONE, FAKE_PERFECT_DVS
...
; ================
	...
	db 45, VENOMOTH, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
if DEF(FAITHFUL)
...
if DEF(FAITHFUL)
	...
	db 44, RAICHU, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
...
; ================
	...
	db 74, VENOMOTH, BRIGHTPOWDER, ABILITY_1 | QUIRKY, FEMALE
if DEF(FAITHFUL)
...
if DEF(FAITHFUL)
	...
	db 73, RAICHU, DRAGON_FANG, ABILITY_1 | QUIRKY, FEMALE
		db THUNDER_WAVE, CONFUSE_RAY, THUNDERBOLT, DRAGON_PULSE
endc
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	db 48, KADABRA, TWISTEDSPOON, 180
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	db 67, KADABRA, TWISTEDSPOON, FAKE_PERFECT_DVS
	...
	db 70, KADABRA, LEFTOVERS, FAKE_PERFECT_DVS
...
; ================
	...
	db 71, GRAVELER, SILK_SCARF, ABILITY_1 | QUIRKY, MALE
...
; ================
	...
	db 47, VENUSAUR, SITRUS_BERRY, 132, "Chicory@"
	db -1 ; end
...
; ================
	...
	db 72, VENUSAUR, SITRUS_BERRY, "Chicory@"
	db -1 ; end
...
; ================
	...
	db 71, RAICHU, NO_ITEM, "RAICHU@"
	db 68, GROWLITHE, NO_ITEM, "GROWLITHE@"
	db 72, CHARIZARD, SITRUS_BERRY, "Cinder@"
	db -1 ; end
...
; ================
	...
	db 71, RAICHU, NO_ITEM, "RAICHU@"
	db 68, GROWLITHE, NO_ITEM, "GROWLITHE@"
	db 72, BLASTOISE, SITRUS_BERRY, "Toto@"
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 58, KADABRA, WISE_GLASSES, ABILITY_1 | QUIRKY, FEMALE
		db SPORE, NASTY_PLOT, HYPER_VOICE, PSYCHIC_M
	db 58, KADABRA, MUSCLE_BAND, ABILITY_1 | QUIRKY, FEMALE
...
; ================
	...
	db 30, KANGASKHAN, PROTECT_PADS, FAKE_PERFECT_DVS, HIDDEN_ABILITY | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	db 57, KADABRA, MIRACLE_SEED, DVS_HP_GRASS ; green
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	; TODO: fix DVs to appropriately color KADABRAs
	db 55, KADABRA, CHARCOAL, DVS_HP_FIRE ; red
		db FIRE_BLAST, FLAMETHROWER, EARTH_POWER, WILL_O_WISP
	db 55, KADABRA, MAGNET, DVS_HP_ELECTRIC ; yellow
		db THUNDER, THUNDERBOLT, THUNDER_WAVE, RAIN_DANCE
	db 55, KADABRA, MYSTIC_WATER, DVS_HP_WATER ; blue
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	db 64, KADABRA, TWISTEDSPOON, DVS_HP_PSYCHIC ; pink
...
; ================
	...
	db 64, GROWLITHE, ABILITY_1 | QUIRKY, FEMALE
	db -1 ; end
...
; ================
	...
	db 35, DRATINI, ROCKY_HELMET, 116, HIDDEN_ABILITY | ADAMANT, MALE
		db SANDSTORM, ROCK_SLIDE, PURSUIT, OUTRAGE
	db 36, GRAVELER, ROCKY_HELMET, 116, ABILITY_1 | ADAMANT, MALE
		db SPIKES, EXPLOSION, SANDSTORM, DIG
	db 36, FEAROW, ROCKY_HELMET, 116, ABILITY_2 | QUIRKY, MALE
...
; ================
	...
	db 42, DODRIO, BLACKGLASSES, ABILITY_1 | QUIRKY, FEMALE
...
; ================
	...
	db 73, CROBAT, MUSCLE_BAND, ABILITY_1 | QUIRKY, FEMALE
		db AIR_SLASH, CRUNCH, X_SCISSOR, POISON_JAB
	db 72, HAUNTER, CHARCOAL, ABILITY_1 | QUIRKY, FEMALE
		db SHADOW_BALL, FLAMETHROWER, DAZZLINGLEAM, POWER_GEM
if DEF(FAITHFUL)
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	db 61, FEAROW, QUICK_CLAW
		db SPIKES, SCREECH, DRILL_PECK, STEEL_WING
	db 60, GRAVELER, FOCUS_BAND
		db EARTHQUAKE, GYRO_BALL, EXPLOSION, SPIKES
if DEF(FAITHFUL)
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	db 78, FEAROW, QUICK_CLAW
		db SPIKES, SCREECH, DRILL_PECK, STEEL_WING
	db 77, GRAVELER, FOCUS_BAND
		db EARTHQUAKE, GYRO_BALL, EXPLOSION, SPIKES
...
; ================
	...
	db 65, MAROWAK, NO_ITEM, FAKE_PERFECT_DVS, ADAMANT | HIDDEN_ABILITY, FEMALE
...
endc
	...
	db 66, DODRIO, QUICK_CLAW, ABILITY_1 | QUIRKY, MALE
...
; ================
	...
	db 58, DODRIO, BLACKGLASSES, 160
		db DRILL_PECK, SUCKER_PUNCH, PURSUIT, BRAVE_BIRD
	db 57, PIDGEOT, QUICK_CLAW, 160
