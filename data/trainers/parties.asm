...
; ================
	...
	db 38, MUK, BLACK_SLUDGE, 208, 160, ABILITY_1 | NAT_NEUTRAL, FEMALE | ALOLAN_FORM
		db SLUDGE_BOMB, DOUBLE_TEAM, GUST, PSYCHIC_M
...
; ================
	...
	; party
	db 15, GYARADOS, ABILITY_1 | NAT_NEUTRAL, FEMALE | GYARADOS_RED_FORM
	db -1 ; end
...
; ================
	...
	db 10, KOFFING, ABILITY_1 | NAT_NEUTRAL, MALE
	db 10, EKANS, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db 10, MEOWTH, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db 10, BULBASAUR, ABILITY_1 | NAT_NEUTRAL, MALE
	db -1 ; end
