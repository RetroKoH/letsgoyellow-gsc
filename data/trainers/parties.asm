...
; ================
	...
	db 80, VENUSAUR, BLACK_SLUDGE
		db SLUDGE_BOMB, GIGA_DRAIN, LEECH_SEED, AMNESIA
	db -1 ; end
...
; ================
	...
	; party
	db 12, GEODUDE
		db TACKLE, DEFENSE_CURL, ROLLOUT, MUD_SLAP
	db 14, ONIX
...
; ================
	...
	db 61, VENUSAUR, NO_ITEM, 192
		db SUNNY_DAY, SYNTHESIS, GIGA_DRAIN, EARTH_POWER
	db 62, TANGELA, EVIOLITE, 192
		db GROWTH, SYNTHESIS, GIGA_DRAIN, SLEEP_POWDER
...
; ================
	...
	db 42, DODUO, NO_ITEM, 120, HIDDEN_ABILITY | HASTY, FEMALE, "Dody@"
		db SWORDS_DANCE, QUICK_ATTACK, RETURN, MUD_SLAP
