...
; ================
	...
	db 72, OMASTAR, MYSTIC_WATER
		db ANCIENTPOWER, SURF, EARTH_POWER, STEALTH_ROCK
	db 72, KABUTOPS, MIRACLE_SEED
		db SLASH, SURF, SWORDS_DANCE, MEGA_DRAIN
...
; ================
	...
	db 71, MAGCARGO, FOCUS_BAND
		db RECOVER, SHELL_SMASH, FLAME_WHEEL, ROCK_SLIDE
...
; ================
	...
	db 38, CHARIZARD
		db SLASH, FLY, OUTRAGE, FLAME_WHEEL
	db -1 ; end
...
; ================
	...
	; party
	db 36, CHARMELEON
		db SMOKESCREEN, METAL_CLAW, DRAGONBREATH, FLAME_WHEEL
	db 35, MAGNETON
...
; ================
	...
	db 41, TYPHLOSION, CHARCOAL
		db FLAME_WHEEL, THUNDERPUNCH, DIG, SUPERPOWER
