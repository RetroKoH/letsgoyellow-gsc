...
; ================
	...
	db 80, SNORLAX, LEFTOVERS
		db CONFUSE_RAY, EARTHQUAKE, FEINT, PROTECT
	...
	db 85, SNORLAX, LEFTOVERS, HIDDEN_ABILITY | ADAMANT, MALE
		db BELLY_DRUM, REST, EARTHQUAKE, GYRO_BALL
...
; ================
	...
	db 72, STEELIX, LEFTOVERS
		db CRUNCH, EARTHQUAKE, STONE_EDGE, IRON_HEAD
...
; ================
	...
	db 61, GASTLY, EVIOLITE, 180, ABILITY_1 | QUIRKY, FEMALE
		db SHADOW_BALL, FLAMETHROWER, DAZZLINGLEAM, ICE_BEAM
	db 61, MAROWAK, THICK_CLUB, 180, ABILITY_1 | QUIRKY, FEMALE
		db SWORDS_DANCE, BONEMERANG, FIRE_PUNCH, THRASH
...
; ================
	...
	db 57, AERODACTYL, KINGS_ROCK, HIDDEN_ABILITY | ADAMANT, MALE
		db AERIAL_ACE, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
...
; ================
	...
	db 65, CHARIZARD, NO_ITEM, 240
		db BELLY_DRUM, WILL_O_WISP, FLAMETHROWER, ROCK_SLIDE
...
; ================
	...
	db 41, GENGAR, SPELL_TAG
		db HYPNOSIS, CONFUSE_RAY, LICK, SHADOW_BALL
	db 42, WEEZING, BRIGHTPOWDER
		db SMOKESCREEN, WILL_O_WISP, EXPLOSION, SLUDGE_BOMB
	db -1 ; end
