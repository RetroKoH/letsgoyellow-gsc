...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	db 11, PSYDUCK, NO_ITEM, 176
		db WATER_PULSE, DISABLE, CALM_MIND, PSYCHIC_M
	db 12, EXEGGCUTE, NO_ITEM, 176
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	db 11, VOLTORB, NO_ITEM, 144
		db SCREECH, DOUBLE_TEAM, WILD_CHARGE, EXPLOSION
	db 12, POLIWAG, NO_ITEM, 144
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_MOVES
	; party
	db 11, KOFFING, NO_ITEM, 208
		db SLUDGE_BOMB, THUNDER, FIRE_BLAST, EXPLOSION
	db 12, DROWZEE, NO_ITEM, 208
...
; ================
	...
	db 65, LEAFEON, LIFE_ORB, 228
		db SEED_BOMB, KNOCK_OFF, DOUBLE_EDGE, SWORDS_DANCE
	db -1 ; end
...
; ================
	...
	db 39, LANTURN
		db FLAIL, WATERFALL, SPARK, CONFUSE_RAY
	db -1 ; end
...
; ================
	...
	db 30, MAGIKARP, ABILITY_1 | NAT_NEUTRAL, MALE | MAGIKARP_CALICO2_FORM
		db SPLASH, STRIKE, FLAIL, DRAGONBREATH
...
; ================
	...
	db 14, EEVEE, EVIOLITE, ABILITY_1 | NAT_SPD_UP_DEF_DOWN, FEMALE, "VuiVui@"
		db DOUBLE_EDGE, SHADOW_BALL, PROTECT, ATTRACT
	db -1 ; end
...
; ================
	...
	db 27, TYROGUE, EVIOLITE
		db STRIKE, RAGE, FORESIGHT, HI_JUMP_KICK
...
; ================
	...
	db 8, GEODUDE, AIR_BALLOON, 12, $DD, $DD, $DD, ABIL_GEODUDE_STURDY | NAT_DEF_UP_SPD_DOWN, MALE
		db STRIKE, DEFENSE_CURL, MUD_SLAP, ROLLOUT
	db 9, MAREEP, AIR_BALLOON, 12, $DD, $DD, $DD, ABIL_MAREEP_STATIC | NAT_SATK_UP_SDEF_DOWN, MALE
		db STRIKE, THUNDER_WAVE, THUNDERSHOCK, MUD_SLAP
	db -1 ; end
