...
; entries correspond to FISHGROUP_* constants
	...
	fishgroup 60 percent + 1, 70 percent + 1, .Goldeen_Swarm_Old,    .Goldeen_Swarm_Good,    .Goldeen_Swarm_Super
	...
	fishgroup 60 percent + 1, 70 percent + 1, .Goldeen_Old,          .Goldeen_Good,          .Goldeen_Super
