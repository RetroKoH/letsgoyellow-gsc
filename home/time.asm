; Functions relating to the timer interrupt (RTC removed)

; do not talk to the RTC hardware in theis version (NO_RTC)
;LatchClock::
...
SetClock::
; do not talk to the RTC hardware in this version (NO_RTC)
	ld hl, hRTCDayHi
	ld de, wNoRTC
	ld bc, 5
	rst CopyBytes
