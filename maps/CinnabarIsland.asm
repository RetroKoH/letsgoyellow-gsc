CinnabarIsland_MapScriptHeader:
	...
	bg_event  8, 15, SIGNPOST_JUMPTEXT, CinnabarIslandSignText
	bg_event 21, 11, SIGNPOST_JUMPTEXT, CinnabarIslandVolcanoWarningSignText
	bg_event 15,  4, SIGNPOST_ITEM + RARE_CANDY, EVENT_CINNABAR_ISLAND_HIDDEN_RARE_CANDY

	db 2 ; object events
	object_event 19, 14, SPRITE_BLUE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
