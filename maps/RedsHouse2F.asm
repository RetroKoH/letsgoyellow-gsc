...
RedsHouse2FSNESText:
	...
	; hm slaves
	givepoke BEEDRILL, 70, MYSTIC_WATER
	loadvar wPartyMon2Moves+0, FELL_STINGER
	loadvar wPartyMon2Moves+1, AGILITY
	loadvar wPartyMon2Moves+2, FOCUS_ENERGY
	loadvar wPartyMon2Moves+3, DRILL_RUN
