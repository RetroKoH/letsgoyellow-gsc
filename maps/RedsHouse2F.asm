...
;	setflag ENGINE_FLYPOINT_SILVER_CAVE
	...
	; test party
	givepoke VENUSAUR,		PLAIN_FORM,		50, LIFE_ORB
	givepoke CHARIZARD, 	PLAIN_FORM,		50, HEAVY_BOOTS
	givepoke BLASTOISE, 	PLAIN_FORM,		50, SITRUS_BERRY
	givepoke BUTTERFREE, 	PLAIN_FORM,		50, LEFTOVERS
	givepoke BEEDRILL,		PLAIN_FORM,		50, FOCUS_SASH
	givepoke PIDGEOT,		PLAIN_FORM,		50, SHARP_BEAK
	givepoke RATICATE,		PLAIN_FORM,		50, FLAME_ORB
	givepoke RATICATE,		ALOLAN_FORM,	50, BLACKGLASSES
	givepoke FEAROW,		PLAIN_FORM,		50, SCOPE_LENS
	givepoke ARBOK,			PLAIN_FORM,		50, BLACK_SLUDGE
	givepoke PIKACHU,		PLAIN_FORM,		50, LIGHT_BALL
	givepoke RAICHU,		PLAIN_FORM,		50, LIFE_ORB
	givepoke RAICHU,		ALOLAN_FORM,	50, LIFE_ORB
	givepoke SANDSLASH,		PLAIN_FORM,		50, SMOOTH_ROCK
	givepoke SANDSLASH,		ALOLAN_FORM,	50, ICY_ROCK
	givepoke NIDOQUEEN,		PLAIN_FORM,		50, LEFTOVERS
	givepoke NIDOKING,		PLAIN_FORM,		50, LIFE_ORB
	givepoke PRIMEAPE,		PLAIN_FORM,		50, LIFE_ORB
	givepoke SLOWKING,		GALARIAN_FORM,	50, LIFE_ORB
	givepoke MAROWAK,		ALOLAN_FORM,	50, THICK_CLUB
	givepoke WEEZING,		GALARIAN_FORM,	50, PINK_BOW
	givepoke ARTICUNO,		PLAIN_FORM,		50, NEVERMELTICE
	givepoke ARTICUNO,		GALARIAN_FORM,	50, TWISTEDSPOON
	; fill pokedex
	callasm FillPokedex
	; intro events
